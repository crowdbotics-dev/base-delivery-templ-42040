...
## Project Structure
    ...
    ├── base_delivery_templ_42040  # Django project configurations
...
1. Clone this repo and `cd base_delivery_templ_42040`
...
2. Clone this repo and `cd base_delivery_templ_42040`
